...
export const PropertyFormModal: React.FC<PropertyFormModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const message = `Olá Volpi! Tenho interesse em um consórcio de Imóvel.\n\n` +
      `*Valor do Imóvel:* ${formData.value}\n` +
      ...
      <div className="bg-bordeaux-900 border border-gold-500/20 w-full max-w-lg rounded-sm shadow-2xl relative overflow-hidden">
        ...
        <div className="p-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h2 className="text-2xl font-serif font-black text-white uppercase tracking-tight">Consórcio Imobiliário</h2>
              <p className="text-gold-500 text-[10px] font-black uppercase tracking-widest">Plano de Aquisição Estratégica</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
              <div>
                <label className="block text-[10px] font-black text-white/40 uppercase tracking-widest mb-2">Valor do Imóvel</label>
                <input
                  required
                  type="text"
              ...
              <div>
                ...
                <input
                  required
                  type="text"
                  placeholder="Ex: R$ 50.000,00 ou Não Tenho"
                  className="w-full bg-white/5 border border-white/10 rounded-sm px-4 py-4 text-white font-bold outline-none focus:border-gold-500 transition-colors"
            ...
            <p className="text-center text-[9px] text-white/20 uppercase font-black tracking-widest">
              Análise personalizada realizada por Felipe Volpi
            </p>
          </form>
        </div>
      </div>
